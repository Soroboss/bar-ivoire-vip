...
import { ShieldCheck, Clock, Building2, Phone, Mail, ArrowRight, Shield } from "lucide-react"
        ...
        <Card className="bg-[#1A1A2E] border-[#3A3A5A] shadow-2xl relative overflow-hidden backdrop-blur-xl border-t-[#D4AF37]/50 border-t-2">
          ...
          <CardContent className="pt-10 pb-10 space-y-8">
            <div className="space-y-4 text-center">
              ...
              <p className="text-xs text-[#A0A0B8] uppercase tracking-[0.3em] font-bold">Analyse de Conformité : 65%</p>
            </div>

            <div className="space-y-6">
              <h2 className="text-2xl font-bold text-white text-center">Votre établissement est en cours de déploiement sécurisé.</h2>
            ...
            <div className="pt-4 space-y-3">
              <Button asChild className="w-full bg-[#D4AF37] text-[#1A1A2E] font-black h-12 rounded-xl group overflow-hidden relative">
              ...
              <Button variant="ghost" asChild className="w-full text-[#A0A0B8] hover:text-white">
