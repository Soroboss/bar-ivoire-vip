...
export default function ReportsPage() {
  ...
  const categoryData = [
    { name: 'Bières', value: orders.length > 0 ? totalRevenue * 0.45 : 450000 },
    { name: 'Spiritueux', value: orders.length > 0 ? totalRevenue * 0.30 : 320000 },
    { name: 'Vins', value: orders.length > 0 ? totalRevenue * 0.15 : 120000 },
    { name: 'Softs/G Grill', value: orders.length > 0 ? totalRevenue * 0.10 : 85000 },
  ]

  const dailyData = [
    { day: 'Lun', sales: 450000 },
    { day: 'Mar', sales: 520000 },
    { day: 'Mer', sales: 480000 },
    { day: 'Jeu', sales: 610000 },
    { day: 'Ven', sales: 850000 },
    { day: 'Sam', sales: 1250000 },
    { day: 'Dim', sales: totalRevenue > 0 ? totalRevenue : 950000 },
  ]
      ...
      <div className="flex flex-col md:flex-row md:items-center justify-between gap-4">
        ...
        <div className="flex gap-3">
          <Button variant="outline" className="border-[#3A3A5A] text-[#A0A0B8]">
            <Calendar className="mr-2 h-4 w-4" /> Déc 2026
          </Button>
      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card className="bg-[#252545] border-[#3A3A5A]">
          <CardHeader className="pb-2">
            <CardDescription className="text-[#A0A0B8]">CA Total</CardDescription>
            <CardTitle className="text-3xl font-bold text-white">{(totalRevenue + 5110000).toLocaleString()} F</CardTitle>
          </CardHeader>
          <CardContent>
