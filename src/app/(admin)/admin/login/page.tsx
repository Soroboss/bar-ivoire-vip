        ...
        <Card className="border border-white/5 shadow-2xl shadow-black/50 rounded-3xl overflow-hidden bg-card backdrop-blur-xl">
          ...
          <CardContent className="p-10">
            ...
            <form onSubmit={handleAdminAuth} className="space-y-5">
              ...
              <div className="space-y-1.5">
                <Label className="text-[10px] font-bold uppercase text-slate-400 ml-1">Code de Sécurité</Label>
                <div className="relative">
                  ...
                  <Input 
                    ...
                    className="bg-slate-50 border-none h-12 pl-12 rounded-xl font-bold text-slate-900 focus:ring-blue-100 transition-all placeholder:text-slate-300"
                    placeholder="••••••••"
                  />
                </div>
              </div>
